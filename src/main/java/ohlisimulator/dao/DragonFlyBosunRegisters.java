...
public class DragonFlyBosunRegisters {
	public static enum DragonFlyBosunFieldName {
	    ...
	    LED_I_SET_10MA("LED_CURRENT"),
	    LED_POWER_SAVING_MODE("LED_POWER_SAVING_MODE"),
	    LED_TIME1_1S("LED_TIME1"),
	    LED_SENSOR_ON_P1("LED_LEVEL1"),
	    LED_TIME2_1S("LED_TIME2"),
	    LED_SENSOR_ON_P2("LED_LEVEL2"),
		LED_TIME3_1S("LED_TIME3"),
		LED_SENSOR_ON_P3("LED_LEVEL3"),
		LED_TIME4_1S("LED_TIME4"),
		LED_SENSOR_ON_P4("LED_LEVEL4"),
		LED_TIME5_1S("LED_TIME5"),
		LED_SENSOR_ON_P5("LED_LEVEL5"),
		LED_TIME6_1S("LED_TIME6"),
		LED_SENSOR_ON_P6("LED_LEVEL6"),
		LED_TIME7_1S("LED_TIME7"),
		LED_SENSOR_ON_P7("LED_LEVEL7"),
		LED_TIME8_1S("LED_TIME8"),
		LED_SENSOR_ON_P8("LED_LEVEL8"),
		LED_TIME9_1S("LED_TIME9"),
		LED_SENSOR_ON_P9("LED_LEVEL9"),
		LED_MORNING_TIME_1S("LED_TIME10"),
		LED_MORNING_SENSOR_ON_P("LED_LEVEL10"),
